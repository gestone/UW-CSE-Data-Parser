...
public enum Action {
    ...
    CORRELATE_TWO_QUARTERS,  // Correlates two raw CS data files, 142 and 143 by calculating correlations for
    ...
    CORRELATE_ONE_QUARTER    // Correlates a student's midterm, homework, and final scores against their overall grade
